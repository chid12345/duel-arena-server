...
VALID_WARRIOR_TYPES = {
    "default",
    "tank",   "tank_0",   "tank_1",   "tank_2",
    "agile",  "agile_0",  "agile_1",  "agile_2",
    "crit",   "crit_0",   "crit_1",   "crit_2",
}
...
def register_warrior_type_route(app: FastAPI) -> None:
    ...
    def set_warrior_type(body: WarriorTypeBody):
        try:
            ...
            logger.exception("warrior-type save error uid=%s wt=%s: %s", body.warrior_type, e)
