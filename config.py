...
CRYPTOPAY_TOKEN = os.getenv("CRYPTOPAY_TOKEN", "562208:AAlbWjsM3rv2K796oeGcaFea2ScX9CBAerL")
# Для тестовой сети CryptoBot используй токен из @CryptoTestnetBot и CRYPTOPAY_TESTNET=1
