...
WB_ABILITIES: Dict[str, Dict[str, Dict[str, Any]]] = {
    ...
    "shadow": {
        "passive": {"name": "Покров теней", "desc": "Периодически уходит в тень — урон по нему слабее, но сразу после открывается окно для бурста.", "stage": 3, "live": False},
        ...
        "t25": {"name": "Затмение", "desc": "Ниже 25% фазы тени и окна сменяются чаще — высокий разброс, лови моменты.", "stage": 3, "live": False},
    },
    "fire": {
        ...
        "t25": {"name": "Сверхновая", "desc": "Ниже 25% каждые пару секунд жжёт всех по площади. Добивайте быстро.", "stage": 3, "live": False},
    },
    "poison": {
        "passive": {"name": "Каменная кожа", "desc": "Часть твоего обычного урона гасится бронёй, НО криты проходят полностью. Качай крит против него.", "stage": 3, "live": False},
        "t75": {"name": "Трещины", "desc": "С 75% HP каждое прошедшее окно уязвимости размягчает его броню — он становится мягче.", "stage": 3, "live": False},
        ...
        "t25": {"name": "Раскол", "desc": "Ниже 25% броня рушится (получает полный урон), но свирепеет (сила ×1.6). Гонка: добей раньше, чем смоет рейд.", "stage": 3, "live": False},
    },
    "spider": {
    ...
    "lava": {
        "passive": {"name": "Толчки", "desc": "Земля трясётся по таймеру — фоновый урон по всем, не зависит от твоих действий. Держи запас HP.", "stage": 3, "live": False},
        "t75": {"name": "Извержение", "desc": "С 75% HP толчки чаще и сильнее.", "stage": 3, "live": False},
        ...
        "t25": {"name": "Каскад", "desc": "Ниже 25% извержения почти без остановки — жёсткий тест на выживание.", "stage": 3, "live": False},
    },
    "demon": {
