...
# Окно входа в активный рейд: с момента старта до 8-й минуты можно
# присоединиться и получить player_state. Последние 2 минуты — «дверь
# закрыта»: новые игроки не могут зайти. Анти-эксплойт: «жду пока корона
# 50/25% сработает, потом захожу с полным HP и забираю награду».
WB_LATE_JOIN_WINDOW_SEC: int = 8 * 60
