...
BOT_NAMES = [
    # Скандинавия / викинги
    "Тор", "Локи", "Один", "Фенрир", "Сигурд", "Рагнар", "Беовульф",
    "Хагрид", "Йорунд", "Бьёрн", "Эйнар", "Бальдр",
    # Греция / Рим / античность
    "Ахилл", "Геракл", "Леонид", "Спартак", "Кратос", "Арес", "Гектор",
    "Аякс", "Максимус", "Брут", "Цезарь",
    # Восток / самураи / монголия
    "Хаттори", "Мусаси", "Кенши", "Ронин", "Сёгун", "Ямато", "Чингис",
    "Тэмудзин", "Рюдзин", "Кодзиро",
    # Стихии / сущности
    "Шторм", "Гром", "Бездна", "Лавина", "Пепел", "Морок", "Тиран",
    "Хаос", "Кошмар",
    # Звериные клички
    "Волк", "Сокол", "Барс", "Ястреб", "Кобра", "Питон", "Гриф",
    "Скорпион", "Дрейк", "Виверн",
]

BOT_PREFIXES = {
    "novice": [
        "Странник", "Юный", "Забытый", "Дикий", "Мрачный", "Тихий",
    ],
    "warrior": [
        "Стальной", "Безмолвный", "Жестокий", "Чёрный", "Железный",
        "Хищный", "Кровавый", "Северный", "Полночный",
    ],
    "master": [
        "Беспощадный", "Гранитный", "Адский", "Багровый", "Тёмный Лорд",
        "Палач", "Пожиратель", "Трёхглавый", "Свирепый",
    ],
    "legend": [
        "Бессмертный", "Король Бездны", "Пожиратель Душ", "Демонолог",
        "Властелин", "Архидемон", "Кошмар Арены", "Багровый Жнец",
        "Сокрушитель", "Древний",
    ],
}
...
FULL_RESET_STARS = int(os.getenv("FULL_RESET_STARS") or "750")
