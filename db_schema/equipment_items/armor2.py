...
ARMOR2: dict[str, dict] = {
    ...
    "armor2_free1": {
        ...
        "str_bonus": 5, "hp_bonus": 40, "body_def_pct": 0.03,
        "special_bonus": "Защита тела −3% · +40 HP",
        "price_gold": 800, "tier": "T1", "power_score": 27,
        "recommended_level": 1, "currency": "gold",
        "texture_key": "armor_free1",
        "desc": "+5 силы, +40 HP, −3% урона по телу — броня для первых боёв",
    },
    "armor2_free2": {
        "slot": "armor2", "rarity": "common",
        "name": "Жилет Следопыта", "emoji": "🛡",
        "agi_bonus": 5, "hp_bonus": 40, "body_def_pct": 0.03,
        "special_bonus": "Защита тела −3% · +40 HP",
        "price_gold": 800, "tier": "T1", "power_score": 27,
        "recommended_level": 1, "currency": "gold",
        "texture_key": "armor_free2",
        "desc": "+5 ловкости, +40 HP, −3% урона по телу — лёгкий доспех разведчика",
    },
    "armor2_free3": {
        "slot": "armor2", "rarity": "common",
    ...
    "armor2_gold1": {
        ...
        "str_bonus": 7, "hp_bonus": 75, "body_def_pct": 0.06,
        "special_bonus": "Защита тела −6% · +75 HP",
        "price_gold": 8000, "tier": "T2", "power_score": 59,
        "recommended_level": 20, "currency": "gold",
        "texture_key": "armor_gold1",
        "desc": "+7 силы, +75 HP, −6% урона по телу — ярость выкованной стали",
    },
    "armor2_gold2": {
        "slot": "armor2", "rarity": "rare",
        "name": "Кольчуга Теней", "emoji": "🛡",
        "agi_bonus": 7, "hp_bonus": 75, "body_def_pct": 0.06,
        "special_bonus": "Защита тела −6% · +75 HP",
        "price_gold": 8000, "tier": "T2", "power_score": 59,
        "recommended_level": 20, "currency": "gold",
        "texture_key": "armor_gold2",
        "desc": "+7 ловкости, +75 HP, −6% урона по телу — бесшумная кольчуга",
    },
    "armor2_gold3": {
        "slot": "armor2", "rarity": "rare",
    ...
    "armor2_dia1": {
        ...
        "str_bonus": 9, "hp_bonus": 120, "body_def_pct": 0.09,
        "special_bonus": "Защита тела −9% · +120 HP",
        "price_diamonds": 75, "tier": "T3", "power_score": 3.0,
        "recommended_level": 45, "currency": "diamond",
        "texture_key": "armor_dia1",
        "desc": "+9 силы, +120 HP, −9% урона по телу — закалены в крови дракона",
    },
    "armor2_dia2": {
        "slot": "armor2", "rarity": "epic",
        "name": "Плащ Ночного Клинка", "emoji": "🛡",
        "agi_bonus": 9, "hp_bonus": 120, "body_def_pct": 0.09,
        "special_bonus": "Защита тела −9% · +120 HP",
        "price_diamonds": 75, "tier": "T3", "power_score": 3.0,
        "recommended_level": 45, "currency": "diamond",
        "texture_key": "armor_dia2",
        "desc": "+9 ловкости, +120 HP, −9% урона по телу — сплетён из лунных нитей",
    },
    "armor2_dia3": {
        "slot": "armor2", "rarity": "epic",
    ...
    "armor2_mythic1": {
        ...
        "str_bonus": 12, "hp_bonus": 180, "body_def_pct": 0.15,
        "special_bonus": "Защита тела −15% · +180 HP",
        "price_usdt": "11.99", "price_stars": 800,
        "tier": "T4", "power_score": 3.58,
        "recommended_level": 65, "currency": "star",
        "texture_key": "armor_mythic1",
        "desc": "+12 силы, +180 HP, −15% урона по телу — выкован в сердце вулкана",
    },
    "armor2_mythic2": {
        "slot": "armor2", "rarity": "mythic",
        "name": "Облачение Призрака Ветров", "emoji": "🔥",
        "agi_bonus": 12, "hp_bonus": 180, "body_def_pct": 0.15,
        "special_bonus": "Защита тела −15% · +180 HP",
        "price_usdt": "11.99", "price_stars": 800,
        "tier": "T4", "power_score": 3.58,
        "recommended_level": 65, "currency": "star",
        "texture_key": "armor_mythic2",
        "desc": "+12 ловкости, +180 HP, −15% урона по телу — сотканы из дыхания бури",
    },
    "armor2_mythic3": {
        "slot": "armor2", "rarity": "mythic",
