...
EQUIPMENT_CATALOG: dict[str, dict] = {
    ...
    # ── ЩИТЫ (shield slot) ──────────────────────────────────
    "shield_free1": {"slot": SLOT_SHIELD, "rarity": RARITY_COMMON, "name": "Щит Ополченца",     "emoji": "🛡️", "def_pct": 0.03, "desc": "-3% урона врага"},
    "shield_free2": {"slot": SLOT_SHIELD, "rarity": RARITY_COMMON, "name": "Щит Стойкости",     "emoji": "🛡️", "hp_bonus": 50, "desc": "+50 HP — запас жизни"},
    "shield_free3": {"slot": SLOT_SHIELD, "rarity": RARITY_COMMON, "name": "Щит Закалённого",   "emoji": "🛡️", "crit_resist_pct": 10, "desc": "-10% крит-урон врага"},
    "shield_free4": {"slot": SLOT_SHIELD, "rarity": RARITY_COMMON, "name": "Щит Дружинника",    "emoji": "🛡️", "def_pct": 0.02, "hp_bonus": 30, "desc": "-2% урона, +30 HP"},
    "shield_gold1": {"slot": SLOT_SHIELD, "rarity": RARITY_RARE, "name": "Рыцарский Щит",       "emoji": "🛡️", "def_pct": 0.06, "price_gold": 1200, "desc": "-6% урона врага"},
    "shield_gold2": {"slot": SLOT_SHIELD, "rarity": RARITY_RARE, "name": "Щит Великана",        "emoji": "🛡️", "hp_bonus": 110, "price_gold": 1400, "desc": "+110 HP"},
    "shield_gold3": {"slot": SLOT_SHIELD, "rarity": RARITY_RARE, "name": "Щит Паладина",        "emoji": "🛡️", "crit_resist_pct": 18, "price_gold": 1700, "desc": "-18% крит-урон врага"},
    "shield_gold4": {"slot": SLOT_SHIELD, "rarity": RARITY_RARE, "name": "Щит Хранителя",       "emoji": "🛡️", "def_pct": 0.04, "hp_bonus": 60, "crit_resist_pct": 8, "price_gold": 2000, "desc": "-4% урона, +60 HP, -8% крит"},
    "shield_dia1":  {"slot": SLOT_SHIELD, "rarity": RARITY_EPIC, "name": "Щит Дракона",         "emoji": "🛡️", "def_pct": 0.10, "price_gold": 0, "price_diamonds": 25, "desc": "-10% урона врага"},
    "shield_dia2":  {"slot": SLOT_SHIELD, "rarity": RARITY_EPIC, "name": "Щит Колосса",         "emoji": "🛡️", "hp_bonus": 200, "price_gold": 0, "price_diamonds": 35, "desc": "+200 HP"},
    "shield_dia3":  {"slot": SLOT_SHIELD, "rarity": RARITY_EPIC, "name": "Щит Непоколебимого",  "emoji": "🛡️", "crit_resist_pct": 25, "price_gold": 0, "price_diamonds": 50, "desc": "-25% крит-урон врага"},
    "shield_dia4":  {"slot": SLOT_SHIELD, "rarity": RARITY_EPIC, "name": "Щит Арканы",          "emoji": "🛡️", "def_pct": 0.07, "hp_bonus": 90, "crit_resist_pct": 12, "price_gold": 0, "price_diamonds": 70, "desc": "-7% урона, +90 HP, -12% крит"},
    "shield_mythic1": {"slot": SLOT_SHIELD, "rarity": "mythic", "name": "Щит Судьбы",           "emoji": "🛡️", "def_pct": 0.14, "hp_bonus": 160, "price_stars": 590, "desc": "-14% урона врага, +160 HP"},
    "shield_mythic2": {"slot": SLOT_SHIELD, "rarity": "mythic", "name": "Щит Бессмертного",     "emoji": "🛡️", "hp_bonus": 300, "crit_resist_pct": 20, "price_stars": 590, "desc": "+300 HP, -20% крит-урон врага"},
    "shield_mythic3": {"slot": SLOT_SHIELD, "rarity": "mythic", "name": "Щит Рока",             "emoji": "🛡️", "def_pct": 0.08, "crit_resist_pct": 30, "price_stars": 590, "desc": "-8% урона врага, -30% крит-урон врага"},
    "shield_mythic4": {"slot": SLOT_SHIELD, "rarity": "mythic", "name": "Щит Богов",            "emoji": "🛡️", "def_pct": 0.10, "hp_bonus": 120, "crit_resist_pct": 18, "price_stars": 590, "desc": "-10% урона, +120 HP, -18% крит"},
    # ── САПОГИ (boots slot) ──────────────────────────────────
    ...
    "boots_free2": {
        ...
        "regen_bonus": 12,
        "desc": "+12 HP/раунд — регенерация в бою",
    },
    "boots_free3": {
        "slot": SLOT_BOOTS, "rarity": RARITY_COMMON,
    ...
    "boots_gold2": {
        ...
        "regen_bonus": 28, "price_gold": 1400,
        "desc": "+28 HP/раунд — живучий в долгом бою",
    },
    "boots_gold3": {
        "slot": SLOT_BOOTS, "rarity": RARITY_RARE,
        "name": "Сапоги Ветра", "emoji": "👟",
        "dodge_bonus": 5, "regen_bonus": 16, "price_gold": 1700,
        "desc": "+5% уворот, +16 HP/раунд",
    },
    "boots_gold4": {
        "slot": SLOT_BOOTS, "rarity": RARITY_RARE,
    ...
    "boots_dia2": {
        ...
        "regen_bonus": 48, "price_gold": 0, "price_diamonds": 35,
        "desc": "+48 HP/раунд — неиссякаемая живучесть",
    },
    "boots_dia3": {
        "slot": SLOT_BOOTS, "rarity": RARITY_EPIC,
    ...
    "boots_mythic2": {
        ...
        "regen_bonus": 65, "dodge_bonus": 5,
        "price_stars": 590,
        "desc": "+65 HP/раунд, +5% уворот — живучесть",
    },
    "boots_mythic3": {
        "slot": SLOT_BOOTS, "rarity": "mythic",
        ...
        "dodge_bonus": 20,
        "price_stars": 590,
        "desc": "+20% уворот — неуловимый боец",
    },
    "boots_mythic4": {
        "slot": SLOT_BOOTS, "rarity": "mythic",
