...
EQUIPMENT_CATALOG: dict[str, dict] = {
    ...
    "helmet_mythic1": {
        ...
        "price_stars": 590,
        "desc": "+42 урона, -10% урона, +160 HP — универсал",
    },
    "helmet_mythic2": {
        "slot": SLOT_BELT, "rarity": "mythic",
        ...
        "price_stars": 590,
        "desc": "+35 урона, +16 крит, -6% урона — для агрессоров",
    },
    "helmet_mythic3": {
        "slot": SLOT_BELT, "rarity": "mythic",
    ...
    "helmet_mythic4": {
        ...
        "price_stars": 590,
        "desc": "-15% урона, +280 HP, +12 крит — неубиваемый",
    },
}
