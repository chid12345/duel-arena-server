...
EQUIPMENT_CATALOG: dict[str, dict] = {
    ...
    "helmet_gold1": {
        ...
        "atk_bonus": 18, "crit_bonus": 5, "price_gold": 8000,
        "desc": "+18 урона, +5 крит",
    },
    "helmet_gold2": {
        "slot": SLOT_BELT, "rarity": RARITY_RARE,
        "name": "Шлем Крепости", "emoji": "⛑️",
        "def_pct": 0.06, "hp_bonus": 90, "price_gold": 8000,
        "desc": "-6% урона врага, +90 HP",
    },
    "helmet_gold3": {
        "slot": SLOT_BELT, "rarity": RARITY_RARE,
        "name": "Шлем Снайпера", "emoji": "⛑️",
        "crit_bonus": 9, "atk_bonus": 14, "price_gold": 8000,
        "desc": "+9 крит, +14 урона",
    },
    "helmet_gold4": {
        "slot": SLOT_BELT, "rarity": RARITY_RARE,
        "name": "Шлем Паладина", "emoji": "⛑️",
        "atk_bonus": 10, "def_pct": 0.04, "hp_bonus": 55, "price_gold": 8000,
    ...
    "shield_gold4": {"slot": SLOT_SHIELD, "rarity": RARITY_RARE, "name": "Щит Хранителя",       "emoji": "🛡️", "def_pct": 0.04, "hp_bonus": 60, "crit_resist_pct": 8, "str_bonus": 1, "agi_bonus": 1, "intu_bonus": 1, "price_gold": 8000, "desc": "-4% урона, +60 HP, -8% крит, +1 ко всем статам"},
    "shield_dia1":  {"slot": SLOT_SHIELD, "rarity": RARITY_EPIC, "name": "Щит Дракона",         "emoji": "🛡️", "def_pct": 0.10, "str_bonus": 2, "agi_bonus": 2, "intu_bonus": 2, "price_diamonds": 75, "desc": "-10% урона врага, +2 ко всем статам"},
    "shield_dia2":  {"slot": SLOT_SHIELD, "rarity": RARITY_EPIC, "name": "Щит Колосса",         "emoji": "🛡️", "hp_bonus": 200, "str_bonus": 2, "agi_bonus": 2, "intu_bonus": 2, "price_diamonds": 75, "desc": "+200 HP, +2 ко всем статам"},
    "shield_dia3":  {"slot": SLOT_SHIELD, "rarity": RARITY_EPIC, "name": "Щит Непоколебимого",  "emoji": "🛡️", "crit_resist_pct": 25, "str_bonus": 2, "agi_bonus": 2, "intu_bonus": 2, "price_diamonds": 75, "desc": "-25% крит-урон врага, +2 ко всем статам"},
    "shield_dia4":  {"slot": SLOT_SHIELD, "rarity": RARITY_EPIC, "name": "Щит Арканы",          "emoji": "🛡️", "def_pct": 0.07, "hp_bonus": 90, "crit_resist_pct": 12, "str_bonus": 2, "agi_bonus": 2, "intu_bonus": 2, "price_diamonds": 75, "desc": "-7% урона, +90 HP, -12% крит, +2 ко всем статам"},
    ...
    "ring_gold4": {"slot": SLOT_RING1, "rarity": RARITY_RARE, "name": "Кольцо Замедления",      "emoji": "💍", "slow_pct": 12,         "price_gold": 8000, "desc": "-12% двойной удар врага"},
    "ring_dia1":  {"slot": SLOT_RING1, "rarity": RARITY_EPIC, "name": "Кольцо Ясновидца",       "emoji": "💍", "accuracy": 12,         "price_diamonds": 75, "desc": "+12% точность"},
    "ring_dia2":  {"slot": SLOT_RING1, "rarity": RARITY_EPIC, "name": "Кольцо Неизбежности",    "emoji": "💍", "anti_dodge_pct": 20,   "price_diamonds": 75, "desc": "-20% уворот врага"},
    "ring_dia3":  {"slot": SLOT_RING1, "rarity": RARITY_EPIC, "name": "Кольцо Молчания",        "emoji": "💍", "silence_pct": 20,      "price_diamonds": 75, "desc": "20% глушит крит врага"},
    "ring_dia4":  {"slot": SLOT_RING1, "rarity": RARITY_EPIC, "name": "Кольцо Оцепенения",      "emoji": "💍", "slow_pct": 20,         "price_diamonds": 75, "desc": "-20% двойной удар врага"},
