...
.rt-body{flex:1;overflow-y:auto;overflow-x:hidden;position:relative;z-index:2;padding-bottom:100px}
...
const _BBC_SLOT_ICON = {weapon:'🗡',shield:'🛡',armor2:'👕',belt:'🪖',boots:'👢',ring1:'💍'};
const _BBC_SLOT_LABEL = {weapon:'Оружие',shield:'Щит',armor2:'Броня',belt:'Шлем',boots:'Сапоги',ring1:'Кольцо'};
const _BBC_SLOT_LAYOUT = {belt:{r:1,c:1},armor2:{r:2,c:1},boots:{r:3,c:1},weapon:{r:1,c:3},shield:{r:2,c:3},ring1:{r:3,c:3}};
