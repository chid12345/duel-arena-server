...
window.WBHtml = (() => {
  ...
  const RES_META = [
    { id:'res_30',  icon:'💊', pct:'30%',  price:'60 🪙',   cur:'gold', desc:'Воскреснуть с 30% HP',   gold:true },
    { id:'res_60',  icon:'💉', pct:'60%',  price:'80 🪙',   cur:'gold', desc:'Воскреснуть с 60% HP',   gold:true },
    { id:'res_100', icon:'✨', pct:'100%', price:'100 🪙',  cur:'gold', desc:'Воскреснуть со 100% HP',  gold:true },
  ];
