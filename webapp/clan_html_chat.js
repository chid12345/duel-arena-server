...
(() => {
const CSS = `
.cc-overlay{position:fixed;top:0;left:0;right:0;bottom:76px;z-index:9000;display:flex;justify-content:center;background:radial-gradient(ellipse at 50% 0%,#1a0a2a 0%,#05050a 55%),#000;color:#e6f7ff;font-family:-apple-system,"Segoe UI",Roboto,sans-serif}
...
.cc-inbar{flex-shrink:0;padding:8px 10px 10px;display:flex;gap:8px;align-items:center;border-top:1px solid rgba(0,240,255,.25);background:linear-gradient(0deg,rgba(15,5,30,.95),rgba(10,0,25,.8))}
