        ...
        this.add.zone(bx, by2, bw, bh).setOrigin(0).setInteractive({ useHandCursor: true })
          ...
          .on('pointerup', async () => {
            ...
            if (res.ok) {
              ...
              _rewardAnim(this, { gold: q.reward_gold, diamonds: q.reward_diamonds },
                () => this.scene.restart({ tab: 'weekly' }));
            } else {
              btnT.setText('Ошибка');
  ...
  async _claimDaily(btnG, btnT, bx, by, bw, bh) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        btnG.setAlpha(0.4); btnT.setText('✅');
        _rewardAnim(this, { gold: res.bonus || 20 },
  ...
  async _claimQuest(clBg, clT) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        clBg.setAlpha(0.4); clT.setText('✅');
        _rewardAnim(this, { gold: res.gold || 40, diamonds: res.diamonds || 1 },
          () => this.scene.restart({ tab: 'daily' }));
      } else {
