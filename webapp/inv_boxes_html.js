...
const _CFG = {
  box_common:      { img:'chest_gold.png',    bc:'#e8a800', gc:'rgba(232,168,0,.22)',  tier:'ЗОЛОТО',    nc:'#ffe080' },
  box_rare:        { img:'chest_diamond.png', bc:'#00c8ff', gc:'rgba(0,200,255,.18)',  tier:'АЛМАЗЫ',    nc:'#80ddff' },
  box_rare_c:      { img:'chest_diamond.png', bc:'#b44fff', gc:'rgba(180,79,255,.18)', tier:'АЛМАЗЫ+',   nc:'#cc88ff' },
  box_epic_e2:     { img:'chest_epic.png',    bc:'#00ff88', gc:'rgba(0,255,136,.18)',  tier:'USDT',      nc:'#80ffbb' },
  box_epic_e3:     { img:'chest_epic.png',    bc:'#00ff88', gc:'rgba(0,255,136,.18)',  tier:'USDT',      nc:'#80ffbb' },
  wb_gold_chest:   { img:'chest_gold.png',    bc:'#e8a800', gc:'rgba(232,168,0,.18)',  tier:'РЕЙД 🏆',  nc:'#ffe080' },
  wb_diamond_chest:{ img:'chest_diamond.png', bc:'#00c8ff', gc:'rgba(0,200,255,.15)',  tier:'РЕЙД 💠',  nc:'#80ddff' },
};

function _cfg(id) {
  return _CFG[id] || { img:'chest_gold.png', bc:'rgba(0,245,255,.4)', gc:'rgba(0,245,255,.1)', tier:'', nc:'#c8d8f0' };
}
...
.ibh-card{display:flex;align-items:center;gap:10px;padding:9px 10px 9px 10px;
  border-radius:12px;margin-bottom:6px;border:1.5px solid;
  background:rgba(8,9,26,.95);backdrop-filter:blur(6px);
  transition:transform .12s,box-shadow .18s}
.ibh-card:active{transform:scale(.975)}
.ibh-img{width:56px;height:56px;object-fit:contain;flex-shrink:0}
...
.ibh-btn{padding:7px 13px;border-radius:8px;border:none;cursor:pointer;
