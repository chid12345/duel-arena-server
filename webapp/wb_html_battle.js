...
<div class="wb-boss-zone bt-${_esc(a.boss_type||'universal')}" id="wb-boss-zone" data-act="hit">
  ...
  <img class="wb-bimg2" id="wb-bimg" src="bosses/${_esc((a.boss_sprite||'boss_lich.webp').replace(/\.png$/i,'.webp'))}?v=a11"
...
<div class="wb-pcard-ov" id="wb-pcov">
  <div class="wb-pcard" id="wb-pc">
    ...
    _bindBattle(root, s);
    // Восстанавливаем визуальное состояние кнопки АВТО после ре-рендера
