...
const ARMOR2_DATA = [
  ...
  {id:'armor2_free1',  r:'common', ht:'🛡 Броня', name:'Кираса Ополченца', stars:'★☆☆☆', str:5, agi:0, intu:0, hp:10, type:'gold', price:'800', tier:'T1', recLevel:1, bonus:'Бронированный: +2% к защите'},
  {id:'armor2_free2',  r:'common', ht:'🛡 Броня', name:'Жилет Следопыта',  stars:'★☆☆☆', str:0, agi:5, intu:0, hp:10, type:'gold', price:'800', tier:'T1', recLevel:1, bonus:'Гибкий: +2% уклон'},
  {id:'armor2_free3',  r:'common', ht:'🛡 Броня', name:'Роба Ученика',     stars:'★☆☆☆', str:0, agi:0, intu:5, hp:10, type:'gold', price:'800', tier:'T1', recLevel:1, bonus:'Острый глаз: +5% крит. урон'},
  {id:'armor2_free4',  r:'common', ht:'🛡 Броня', name:'Плащ Странника',   stars:'★☆☆☆', str:2, agi:2, intu:2, hp:4,  type:'gold', price:'800', tier:'T1', recLevel:1, bonus:'Сбалансирован: +1% к макс. HP'},
  // ── Редкие (rare) — 8000 gold, T2, уровень 20
  {id:'armor2_gold1',  r:'rare',   ht:'🛡 Броня', name:'Панцирь Берсерка', stars:'★★☆☆', str:7, agi:0, intu:0, hp:14, type:'gold', price:'8000', tier:'T2', recLevel:20, bonus:'Берсерк: урон +4% при HP < 30%'},
  {id:'armor2_gold2',  r:'rare',   ht:'🛡 Броня', name:'Кольчуга Теней',   stars:'★★☆☆', str:0, agi:7, intu:0, hp:14, type:'gold', price:'8000', tier:'T2', recLevel:20, bonus:'Теневой удар: +4% шанс двойного удара'},
  {id:'armor2_gold3',  r:'rare',   ht:'🛡 Броня', name:'Мантия Чародея',   stars:'★★☆☆', str:0, agi:0, intu:7, hp:14, type:'gold', price:'8000', tier:'T2', recLevel:20, bonus:'Чародей: крит. урон +4%'},
  {id:'armor2_gold4',  r:'rare',   ht:'🛡 Броня', name:'Броня Стража',     stars:'★★☆☆', str:4, agi:4, intu:4, hp:8,  type:'gold', price:'8000', tier:'T2', recLevel:20, bonus:'Страж: входящий урон −3%'},
  // ── Эпические (epic) — 75 алмазов, T3, уровень 45
  {id:'armor2_dia1',   r:'epic',   ht:'🛡 Броня', name:'Латы Кровавого Вождя', stars:'★★★☆', str:9, agi:0, intu:0, hp:18, type:'diamonds', price:'75', tier:'T3', recLevel:45, bonus:'Ярость Вождя: урон +6% при HP < 40%'},
  {id:'armor2_dia2',   r:'epic',   ht:'🛡 Броня', name:'Плащ Ночного Клинка',  stars:'★★★☆', str:0, agi:9, intu:0, hp:18, type:'diamonds', price:'75', tier:'T3', recLevel:45, bonus:'Ночной Клинок: +6% шанс двойного удара'},
  {id:'armor2_dia3',   r:'epic',   ht:'🛡 Броня', name:'Одеяние Архимага',     stars:'★★★☆', str:0, agi:0, intu:9, hp:18, type:'diamonds', price:'75', tier:'T3', recLevel:45, bonus:'Архимаг: крит. урон +6%'},
  {id:'armor2_dia4',   r:'epic',   ht:'🛡 Броня', name:'Латы Паладина Зари',   stars:'★★★☆', str:6, agi:6, intu:6, hp:12, type:'diamonds', price:'75', tier:'T3', recLevel:45, bonus:'Заря: входящий урон −6%'},
  // ── Мифические (mythic) — $11.99 / ⭐800, T4, уровень 65
  {id:'armor2_mythic1',r:'mythic', ht:'🛡 Броня', name:'Доспех Пламенного Титана', stars:'★★★★', str:12, agi:0, intu:0, hp:24, type:'mythic', tier:'T4', recLevel:65, bonus:'Пламя Ярости: урон +12% при HP < 30%'},
  {id:'armor2_mythic2',r:'mythic', ht:'🛡 Броня', name:'Облачение Призрака Ветров',stars:'★★★★', str:0, agi:12, intu:0, hp:24, type:'mythic', tier:'T4', recLevel:65, bonus:'Ветра: +9% шанс двойного удара'},
  {id:'armor2_mythic3',r:'mythic', ht:'🛡 Броня', name:'Регалии Повелителя Молний',stars:'★★★★', str:0, agi:0, intu:12, hp:24, type:'mythic', tier:'T4', recLevel:65, bonus:'Повелитель Молний: крит. урон +18%'},
