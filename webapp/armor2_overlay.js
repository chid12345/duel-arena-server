...
const ARMOR2_DATA = [
  ...
  {id:'armor2_free1',  r:'common', ht:'🛡 Броня', name:'Кираса Ополченца', stars:'★☆☆☆', str:5, agi:0, intu:0, hp:40, type:'gold', price:'800', tier:'T1', recLevel:1, bonus:'🛡 Защита тела −3% · +40 HP'},
  {id:'armor2_free2',  r:'common', ht:'🛡 Броня', name:'Жилет Следопыта',  stars:'★☆☆☆', str:0, agi:5, intu:0, hp:40, type:'gold', price:'800', tier:'T1', recLevel:1, bonus:'🛡 Защита тела −3% · +40 HP'},
  ...
  {id:'armor2_gold1',  r:'rare',   ht:'🛡 Броня', name:'Панцирь Берсерка', stars:'★★☆☆', str:7, agi:0, intu:0, hp:75, type:'gold', price:'8000', tier:'T2', recLevel:20, bonus:'🛡 Защита тела −6% · +75 HP'},
  {id:'armor2_gold2',  r:'rare',   ht:'🛡 Броня', name:'Кольчуга Теней',   stars:'★★☆☆', str:0, agi:7, intu:0, hp:75, type:'gold', price:'8000', tier:'T2', recLevel:20, bonus:'🛡 Защита тела −6% · +75 HP'},
  ...
  {id:'armor2_dia1',   r:'epic',   ht:'🛡 Броня', name:'Латы Кровавого Вождя', stars:'★★★☆', str:9, agi:0, intu:0, hp:120, type:'diamonds', price:'75', tier:'T3', recLevel:45, bonus:'🛡 Защита тела −9% · +120 HP'},
  {id:'armor2_dia2',   r:'epic',   ht:'🛡 Броня', name:'Плащ Ночного Клинка',  stars:'★★★☆', str:0, agi:9, intu:0, hp:120, type:'diamonds', price:'75', tier:'T3', recLevel:45, bonus:'🛡 Защита тела −9% · +120 HP'},
  ...
  {id:'armor2_mythic1',r:'mythic', ht:'🛡 Броня', name:'Доспех Пламенного Титана', stars:'★★★★', str:12, agi:0, intu:0, hp:180, type:'mythic', tier:'T4', recLevel:65, bonus:'🛡 Защита тела −15% · +180 HP'},
  {id:'armor2_mythic2',r:'mythic', ht:'🛡 Броня', name:'Облачение Призрака Ветров',stars:'★★★★', str:0, agi:12, intu:0, hp:180, type:'mythic', tier:'T4', recLevel:65, bonus:'🛡 Защита тела −15% · +180 HP'},
