...
const STAT_INFO = {
  strength: {
    ...
    cls_hint:'⚔ <b>Берсерк</b>: +10% урон, но −5% уворот',
  ...
  intuition: {
    ...
    effects:[
      ...
      ['🔪','<b>Крит-пробой блока</b> — при блоке критом урон всё равно проходит (×0.7)'],
    ],
  ...
  stamina: {
    ...
    effects:[
      ...
      ['⏱','<b>Восстановление HP</b> — каждое вложение даёт +5% к скорости регена вне боя'],
