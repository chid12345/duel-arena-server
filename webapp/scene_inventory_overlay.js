...
(() => {
  ...
  const ITEM_META = {
    ...
    // ── Ящики ──
    box_common:     { icon:'📦', name:'Обычный ящик',          desc:'Случайный предмет', tab:'special' },
    box_rare:       { icon:'🟦', name:'Редкий ящик',           desc:'Ценный предмет · шанс 5% на особый', tab:'special' },
    box_epic:       { icon:'🟣', name:'Эпический ящик',        desc:'Гарантированный особый предмет', tab:'special' },
    // ── Эликсиры ──
