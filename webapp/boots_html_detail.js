...
const BOOTS_DESC = {
  ...
  boots_free4:   'Острая реакция — удар уходит в пустоту. Лучший стартовый выбор.',
  ...
  boots_gold4:   'Фантом: каждый пропущенный удар — шанс исчезнуть снова.',
  ...
  boots_dia4:    'Бессмертный держится за счёт неугасающей регенерации.',
  ...
  boots_mythic4: 'Абсолютный Шаг сочетает мощный уворот с непрерывным исцелением.',
};
