...
// ARMORS_DATA (старая снесённая система брони) удалён — этап 6 аудита.
// Это были фантомные статы/классовые пассивки старого armor, которых нет в
// armor2. В бою они не срабатывали (current_class=NULL), а карточки обещали
// несуществующие эффекты («Пламя Ярости +12%» и т.п.). Новая броня — в
// armor2_overlay.js (ARMOR2_DATA). Этот файл оставлен ради общего CSS
// (_injectCSS его шарят все *_html_overlay).
