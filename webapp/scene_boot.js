...
class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('armor_free1',   'armor_free1.png');
    this.load.image('armor_free2',   'armor_free2.png');
    this.load.image('armor_free3',   'armor_free3.png');
    this.load.image('armor_free4',   'armor_free4.png');
    this.load.image('armor_gold1',   'armor_gold1.png');
    this.load.image('armor_gold2',   'armor_gold2.png');
    this.load.image('armor_gold3',   'armor_gold3.png');
    this.load.image('armor_gold4',   'armor_gold4.png');
    this.load.image('armor_dia1',    'armor_dia1.png');
    this.load.image('armor_dia2',    'armor_dia2.png');
    this.load.image('armor_dia3',    'armor_dia3.png');
    this.load.image('armor_dia4',    'armor_dia4.png');
    this.load.image('armor_mythic1', 'armor_mythic1.png');
    this.load.image('armor_mythic2', 'armor_mythic2.png');
    this.load.image('armor_mythic3', 'armor_mythic3.png');
    this.load.image('armor_mythic4', 'armor_mythic4.png');
