...
const DATA = {
  consumables: [
    ...
    ['xp_boost_5',  '⚡','XP Буст ×1.5',    300, 'gold',    '5 боёв → инвентарь',      '5 БОЁВ',false],
    ['xp_boost_20', '⚡','XP Буст ×1.5',     72, 'diamonds','20 боёв → инвентарь',     '20 БОЁВ',false],
    ['xp_boost_x2', '🚀','XP Буст ×2.0',     40, 'diamonds','10 боёв → инвентарь',    '10 БОЁВ',false],
    ['gold_hunt',   '💰','Охота за золотом',  40, 'diamonds','+20% золото · 24ч',      '24 ЧАСА',false],
    ['xp_hunt',     '📚','Охота за опытом',   40, 'diamonds','+50% опыта · 24ч',       '24 ЧАСА',false],
    ['stat_reset',  '🔄','Сброс статов',     290, 'diamonds','Сброс всех статов',       null,   false],
  ],
  scrolls: [
    ...
    ['scroll_shadow',  '🌑','Комбо Тени',          145, 'gold',   'Ловк+3, Уворот+3%',        '1 БОЙ', false],
    ['scroll_fury',    '💥','Комбо Ярости',        180, 'gold',   'Сила+4, Крит+2',           '1 БОЙ', false],
    ['scroll_vampire_g','🩸','Свиток Вампира',     450, 'gold',   'Вампиризм 9% · 1 бой',     '1 БОЙ', false],
    ...
    ['scroll_armor_10','🛡️','Свиток брони 10%',    48, 'diamonds','Броня +10% · 3 боя',      '3 БОЯ', false],
    ['scroll_hp_200',  '❤️','Эликсир HP +200',     25, 'diamonds','+200 HP · 3 боя',          '3 БОЯ', false],
    ['scroll_double_10','⚡','Двойной удар +10%',   60, 'diamonds','Двойной удар +10% · 3 боя','3 БОЯ', false],
    ['scroll_all_4',   '✨','Все пассивки +4',      72, 'diamonds','Все статы +4 · 1 бой',    '1 БОЙ', false],
    ['scroll_bastion', '🏰','Бастион',              60, 'diamonds','Ловк+5, Броня+8% · 3 боя','3 БОЯ', false],
    ['scroll_predator','🐍','Хищник',               60, 'diamonds','Крит+5, Двойн+8% · 3 боя','3 БОЯ', false],
    ['scroll_berserker','🔥','Берсерк',             72, 'diamonds','Сила+8, Броня-5% · 3 боя','3 БОЯ', true],
    ['scroll_accuracy','🎯','Точность +15%',        20, 'diamonds','Точность +15% · 3 боя',   '3 БОЯ', false],
    ['scroll_vampire_d','🧛','Свиток Вампира+',    72, 'diamonds','Вампиризм 15% · 3 боя',    '3 БОЯ', false],
  ],
  boxes: [
