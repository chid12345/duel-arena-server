...
const DATA = {
  consumables: [
    ...
    ['xp_boost_5',  '⚡','XP Буст ×1.5',    100, 'gold',    '5 боёв',                  '5 БОЁВ',false],
  ...
  scrolls: [
    ...
    ['scroll_crit_3',  '🎯','Интуиция +3',          75, 'gold',   'Интуиция +3 · 1 бой',     '1 БОЙ', false],
    ...
    ['scroll_crit_6',  '🎯','Интуиция +6',          25, 'diamonds','Интуиция +6 · 3 боя',     '3 БОЯ', false],
  ...
  boxes: [
    ...
    ['box_common',     '📦','Обычный ящик',    150, 'gold',    '2–4 свитка · шанс алмазный', null, false],
    ['box_rare',       '🟦','Редкий ящик',      50,  'diamonds','3–6 алмазных свитков',  null, false],
    ['box_rare_c',     '🟪','Редкий ящик+',     80,  'diamonds','2+ алмазных · шанс 300💎 и Premium', null, false],
  ],
};
